...
typedef enum {
    ...
    SIGNAL_POINTER_MOTION_X,
    SIGNAL_POINTER_MOTION_Y,
    SIGNAL_POINTER_POSITION_RESET,
    SIGNAL_POINTER_POSITION_X,
    SIGNAL_POINTER_POSITION_Y,
    SIGNAL_POINTER_BUTTON,
