...
build/aura.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   aura.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/aura.o -Isrc -Igen \
	       -c src/aura.c
...
build/config.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   config.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/config.o -Isrc -Igen \
	       -c src/config.c
...
build/global-functions.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/global-functions.o -Isrc -Igen \
...
build/utils-chain.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/utils-chain.o -Isrc -Igen \
	       -c src/utils-chain.c
...
build/utils-branch.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/utils-branch.o -Isrc -Igen \
...
build/utils-dbus.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/utils-dbus.o -Isrc -Igen \
	       -c src/utils-dbus.c \
...
build/utils-keymap.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/utils-keymap.o -Isrc -Igen \
...
build/utils-environment.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/utils-environment.o -Isrc -Igen \
...
build/event-dispatcher.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/event-dispatcher.o -Isrc -Igen \
...
build/event-timer.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/event-timer.o -Isrc -Igen \
	       -c src/event-timer.c
...
build/event-signals.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/event-signals.o -Isrc -Igen \
...
build/event-loop.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/event-loop.o -Isrc -Igen \
	       -c src/event-loop.c
...
build/event-task.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/event-task.o -Isrc -Igen \
	       -c src/event-task.c
...
build/event-factory.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/event-factory.o -Isrc -Igen \
...
build/device-common.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/device-common.o -Isrc -Igen \
...
build/device-fb.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   device-fb.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/device-fb.o -Isrc -Igen \
	       -c src/device-fb.c
...
build/device-drm.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/device-drm.o -Isrc -Igen \
	       -c src/device-drm.c \
...
build/device-evdev.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/device-evdev.o -Isrc -Igen \
...
build/device-udev.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/device-udev.o -Isrc -Igen \
	       -c src/device-udev.c
...
build/output.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   output.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/output.o -Isrc -Igen \
	       -c src/output.c
...
build/output-collector.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/output-collector.o -Isrc -Igen \
...
build/surface-data.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/surface-data.o -Isrc -Igen \
...
build/keyboard-bindings.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/keyboard-bindings.o -Isrc -Igen \
...
build/exhibitor.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   exhibitor.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/exhibitor.o -Isrc -Igen \
	       -c src/exhibitor.c
...
build/exhibitor-display.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/exhibitor-display.o -Isrc -Igen \
...
build/exhibitor-compositor.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/exhibitor-compositor.o -Isrc -Igen \
...
build/exhibitor-strategist.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/exhibitor-strategist.o -Isrc -Igen \
...
build/exhibitor-pointer.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/exhibitor-pointer.o -Isrc -Igen \
...
build/renderer-mmap.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/renderer-mmap.o -Isrc -Igen \
...
build/renderer-gl.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/renderer-gl.o -Isrc -Igen \
	       -c src/renderer-gl.c \
	       -I/usr/include/libdrm 
...
build/wayland.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   wayland.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland.o -Isrc -Igen \
	       -c src/wayland.c
...
build/wayland-state.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-state.o -Isrc -Igen \
...
build/wayland-protocol-compositor.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-compositor.o -Isrc -Igen \
...
build/wayland-protocol-surface.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-surface.o -Isrc -Igen \
...
build/wayland-protocol-region.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-region.o -Isrc -Igen \
...
build/wayland-protocol-shell-surface.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-shell-surface.o -Isrc -Igen \
...
build/xdg-shell-protocol.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/xdg-shell-protocol.o -Isrc -Igen \
...
build/wayland-protocol-output.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-output.o -Isrc -Igen \
...
build/wayland-protocol-seat.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-seat.o -Isrc -Igen \
...
build/wayland-protocol-pointer.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-pointer.o -Isrc -Igen \
...
build/wayland-protocol-keyboard.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/wayland-protocol-keyboard.o -Isrc -Igen \
...
build/bind-egl-wayland.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/bind-egl-wayland.o -Isrc -Igen \
...
build/backend-gtk-res.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/backend-gtk-res.o -Isrc -Igen \
...
build/backend-gtk-app.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/backend-gtk-app.o -Isrc -Igen \
...
build/backend-gtk.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o build/backend-gtk.o -Isrc -Igen \
	       -c src/backend-gtk.c \
	       -pthread -I/usr/include/gtk-3.0 -I/usr/include/at-spi2-atk/2.0 -I/usr/include/at-spi-2.0 -I/usr/include/dbus-1.0 -I/usr/lib/dbus-1.0/include -I/usr/include/gtk-3.0 -I/usr/include/gio-unix-2.0/ -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/harfbuzz -I/usr/include/freetype2 -I/usr/include/harfbuzz -I/usr/include/libdrm -I/usr/include/libpng16 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng16 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include 
...
checks/check-chain: Makefile \
	...
	@mkdir -p checks
	@echo "  CC   check-chain"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o checks/check-chain -Isrc -Igen \
...
checks/check-store: Makefile \
	...
	@mkdir -p checks
	@echo "  CC   check-store"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -DDEBUG -g -pg -O0 -o checks/check-store -Isrc -Igen \
