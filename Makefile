...
build/aura.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   aura.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/aura.o -Isrc -Igen \
	       -c src/aura.c
...
build/config.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   config.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/config.o -Isrc -Igen \
	       -c src/config.c
...
build/global-functions.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/global-functions.o -Isrc -Igen \
...
build/utils-chain.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/utils-chain.o -Isrc -Igen \
	       -c src/utils-chain.c
...
build/utils-branch.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/utils-branch.o -Isrc -Igen \
...
build/utils-store.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/utils-store.o -Isrc -Igen \
	       -c src/utils-store.c
...
build/utils-dbus.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/utils-dbus.o -Isrc -Igen \
	       -c src/utils-dbus.c \
...
build/utils-keymap.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/utils-keymap.o -Isrc -Igen \
...
build/utils-log.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   utils-log.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/utils-log.o -Isrc -Igen \
	       -c src/utils-log.c
...
build/utils-environment.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/utils-environment.o -Isrc -Igen \
...
build/event-dispatcher.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/event-dispatcher.o -Isrc -Igen \
...
build/event-timer.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/event-timer.o -Isrc -Igen \
	       -c src/event-timer.c
...
build/event-signals.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/event-signals.o -Isrc -Igen \
...
build/event-loop.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/event-loop.o -Isrc -Igen \
	       -c src/event-loop.c
...
build/event-task.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/event-task.o -Isrc -Igen \
	       -c src/event-task.c
...
build/event-factory.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/event-factory.o -Isrc -Igen \
...
build/device-common.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/device-common.o -Isrc -Igen \
...
build/device-fb.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   device-fb.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/device-fb.o -Isrc -Igen \
	       -c src/device-fb.c
...
build/device-drm.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/device-drm.o -Isrc -Igen \
	       -c src/device-drm.c \
...
build/device-evdev.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/device-evdev.o -Isrc -Igen \
...
build/device-udev.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/device-udev.o -Isrc -Igen \
	       -c src/device-udev.c
...
build/output.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   output.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/output.o -Isrc -Igen \
	       -c src/output.c
...
build/output-collector.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/output-collector.o -Isrc -Igen \
...
build/surface-data.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/surface-data.o -Isrc -Igen \
...
build/surface-manager.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/surface-manager.o -Isrc -Igen \
...
build/keyboard-bindings.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/keyboard-bindings.o -Isrc -Igen \
...
build/keyboard-mode.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/keyboard-mode.o -Isrc -Igen \
...
build/keyboard-argmand.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/keyboard-argmand.o -Isrc -Igen \
...
build/exhibitor.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   exhibitor.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/exhibitor.o -Isrc -Igen \
	       -c src/exhibitor.c
...
build/exhibitor-display.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/exhibitor-display.o -Isrc -Igen \
...
build/exhibitor-compositor.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/exhibitor-compositor.o -Isrc -Igen \
...
build/exhibitor-frame.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/exhibitor-frame.o -Isrc -Igen \
...
build/exhibitor-strategist.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/exhibitor-strategist.o -Isrc -Igen \
...
build/exhibitor-pointer.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/exhibitor-pointer.o -Isrc -Igen \
...
build/renderer-mmap.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/renderer-mmap.o -Isrc -Igen \
...
build/renderer-gl.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/renderer-gl.o -Isrc -Igen \
	       -c src/renderer-gl.c \
	       -I/usr/include/libdrm 
...
build/wayland.o: Makefile \
	...
	@mkdir -p build
	@echo "  CC   wayland.o"
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland.o -Isrc -Igen \
	       -c src/wayland.c
...
build/wayland-output.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-output.o -Isrc -Igen \
...
build/wayland-state.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-state.o -Isrc -Igen \
...
build/wayland-protocol-compositor.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-compositor.o -Isrc -Igen \
...
build/wayland-protocol-surface.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-surface.o -Isrc -Igen \
...
build/wayland-protocol-region.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-region.o -Isrc -Igen \
...
build/wayland-protocol-shell.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-shell.o -Isrc -Igen \
...
build/wayland-protocol-shell-surface.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-shell-surface.o -Isrc -Igen \
...
build/wayland-protocol-xdg-shell.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-xdg-shell.o -Isrc -Igen \
...
build/xdg-shell-protocol.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/xdg-shell-protocol.o -Isrc -Igen \
...
build/wayland-protocol-output.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-output.o -Isrc -Igen \
...
build/wayland-protocol-seat.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-seat.o -Isrc -Igen \
...
build/wayland-protocol-pointer.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-pointer.o -Isrc -Igen \
...
build/wayland-protocol-keyboard.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/wayland-protocol-keyboard.o -Isrc -Igen \
...
build/bind-egl-wayland.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/bind-egl-wayland.o -Isrc -Igen \
...
build/backend-gtk.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/backend-gtk.o -Isrc -Igen \
	       -c src/backend-gtk.c \
...
build/backend-gtk-app.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/backend-gtk-app.o -Isrc -Igen \
...
build/backend-gtk-win.o: Makefile \
	...
	@gcc -std=gnu11 -Wall -W -Wextra -Wpedantic -o build/backend-gtk-win.o -Isrc -Igen \
